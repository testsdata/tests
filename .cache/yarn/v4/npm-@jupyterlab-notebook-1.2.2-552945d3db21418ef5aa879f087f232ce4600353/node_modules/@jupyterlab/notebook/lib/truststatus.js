...
function NotebookTrustComponent(props) {
    if (props.allCellsTrusted) {
        return React.createElement(DefaultIconReact, { name: "trusted", top: '2px', kind: 'statusBar' });
    }
    else {
        return (React.createElement(DefaultIconReact, { name: "not-trusted", top: '2px', kind: 'statusBar' }));
    }
}
/**
