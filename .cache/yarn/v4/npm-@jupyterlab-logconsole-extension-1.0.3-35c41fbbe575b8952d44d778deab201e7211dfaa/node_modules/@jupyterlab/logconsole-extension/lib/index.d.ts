...
declare const _default: (import("@phosphor/application").IPlugin<JupyterFrontEnd<JupyterFrontEnd.IShell>, ILoggerRegistry> | import("@phosphor/application").IPlugin<JupyterFrontEnd<JupyterFrontEnd.IShell>, void>)[];
