...
(function (Private) {
    ...
    function populateList(registry, selection, node) {
        ...
        const items = plugins.map(plugin => {
            ...
            const iconClass = combineClasses(image, 'jp-PluginList-icon', 'jp-MaterialIcon');
            ...
            return (React.createElement("li", { className: id === selection ? 'jp-mod-selected' : '', "data-id": id, key: id, title: itemTitle },
                defaultIconRegistry.contains(image) ? (React.createElement(DefaultIconReact, { name: image, title: iconTitle, className: '', tag: 'span', kind: 'settingsEditor' })) : (React.createElement("span", { className: iconClass, title: iconTitle })),
