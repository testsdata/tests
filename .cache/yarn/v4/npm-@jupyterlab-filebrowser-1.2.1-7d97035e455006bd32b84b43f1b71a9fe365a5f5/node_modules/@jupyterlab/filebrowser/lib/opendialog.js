...
(function (FileDialog) {
    ...
    function getExistingDirectory(options) {
        return getOpenFiles(Object.assign({}, options, { filter: model => false }));
    }
...
class OpenDialog extends Widget {
    constructor(iconRegistry, manager, filter) {
        super();
        this.addClass(OPEN_DIALOG_CLASS);
        this._browser = Private.createFilteredFileBrowser('filtered-file-browser-dialog', iconRegistry, manager, filter);
...
(function (Private) {
     ...
     * instance.
     */
    Private.createFilteredFileBrowser = (id, iconRegistry, manager, filter, options = {}) => {
