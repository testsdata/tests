 ...
 */
export declare function createEditMenu(app: JupyterFrontEnd, menu: EditMenu): void;
/**
 * Create the basic `File` menu.
 */
export declare function createFileMenu(app: JupyterFrontEnd, menu: FileMenu, router: IRouter): void;
/**
 * Create the basic `Kernel` menu.
 */
export declare function createKernelMenu(app: JupyterFrontEnd, menu: KernelMenu): void;
/**
 * Create the basic `View` menu.
 */
export declare function createViewMenu(app: JupyterFrontEnd, menu: ViewMenu): void;
/**
 * Create the basic `Run` menu.
 */
export declare function createRunMenu(app: JupyterFrontEnd, menu: RunMenu): void;
/**
 * Create the basic `Settings` menu.
 */
export declare function createSettingsMenu(_: JupyterFrontEnd, menu: SettingsMenu): void;
/**
 * Create the basic `Tabs` menu.
 */
export declare function createTabsMenu(app: JupyterFrontEnd, menu: TabsMenu, labShell: ILabShell | null): void;
