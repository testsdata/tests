...
export class GridSearchService {
    ...
    find(query, reverse = false) {
        ...
        const maxRow = (this._grid.scrollY + this._grid.pageHeight) / this._grid.baseRowSize;
        const minColumn = this._grid.scrollX / this._grid.baseColumnSize;
        const maxColumn = (this._grid.scrollX + this._grid.pageWidth) / this._grid.baseColumnSize;
